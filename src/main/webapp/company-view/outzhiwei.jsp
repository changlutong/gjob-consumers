...
<table class="layui-table" lay-data="{width: 1100, height:500, url:'<%=request.getContextPath()%>/companycltController/getzhiweilistfor2.do?companyid=17338125780', page:true, id:'idTest'}" lay-filter="demo">
    <thead>
    <tr>
        <%--<th lay-data="{type:'checkbox', fixed: 'left'}"></th>--%>
        <th lay-data="{field:'workname', width:'15%', sort: true, fixed: true}">职位名称</th>
        <th lay-data="{field:'worktype', width:'15%'}">职位类型</th>
        <th lay-data="{field:'workpro', width:'15%'}">职位性质</th>
