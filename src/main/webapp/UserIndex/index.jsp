        ...
        <div class="row clearfix">
            <div style="Float:left"><br>
               <font size="4" color="blue">姓名:</font><span id="spanname"></span><br><br>
                ...
                <font size="4" color="blue">邮件:</font><a><span id="spanmail"></span></a><br><br>
            ...
            $.ajax({
                ...
                success:function (succen){
                    ...
                    if (count > 0){
                        ...
                        var divphoto = " <center><img src='<%=request.getContextPath()%>/UserIndex/imgs/123.jpg'/><br></center><br><div><center><img src='<%=request.getContextPath()%>/UserIndex/imgs/sx.jpg'/><img src='<%=request.getContextPath()%>/UserIndex/imgs/xg.jpg'/><img src='<%=request.getContextPath()%>/UserIndex/imgs/jltd.jpg'/><img src='<%=request.getContextPath()%>/UserIndex/imgs/wdtd.jpg'/><img src='<%=request.getContextPath()%>/UserIndex/imgs/hdsy.jpg'/></center></div>"
                        $("#divphoto").html(divphoto);
                    }
                },
                error:function(){
