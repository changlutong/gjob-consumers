...
<input type="hidden"  id="qitaid"  name="qitaid" />
...
<script type="text/javascript">
    ...
    var usergrxxid = '<%=request.getParameter("usergrxxid")%>'


        $("#qitaid").val(usergrxxid);
    ...
    $(function(){
        ...
        $.ajax({
            ...
            success:function (succen){
                ...
                if (count > 0){
                    var divphoto = " <center><img src='"+succen[0].zpfjurl+"' style='width:200px;heighe:190px'/></center></div>"
                    $("#divphoto").html(divphoto);
                }else{
                    var divphoto = " <center><img src='<%=request.getContextPath()%>/UserIndex/imgs/123.jpg'/></center></div>"
                    $("#divphoto").html(divphoto);
                }
            },
            error:function(){
